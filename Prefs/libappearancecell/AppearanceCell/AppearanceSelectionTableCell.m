...
- (void)buttonTapped:(UILongPressGestureRecognizer *)sender {
    if(sender.state == UIGestureRecognizerStateBegan) {
        ...
        NSString *path = [NSString stringWithFormat:@"/User/Library/Preferences/%@.plist", self.defaultsPath];
        NSMutableDictionary *settings = [NSMutableDictionary dictionary];
        [settings addEntriesFromDictionary:[NSDictionary dictionaryWithContentsOfFile:path]];
        [settings setObject:[NSNumber numberWithInt:self.type] forKey:self.key];
